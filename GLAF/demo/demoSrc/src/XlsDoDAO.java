...
import baseSrc.common.ExcelToPDF;
public class XlsDoDAO extends BaseDAO{
	...
	public SysBaseDTOMap PDFSC(XlsDoForm form,SysBaseCom baseCom) {
		SysBaseDTOMap ret = new SysBaseDTOMap();
		//将xls中数据导入map中
		ExcelToPDF exlToPDF=new ExcelToPDF();
		try{
			exlToPDF.createPDF("D:\\test.xls", "D:\\test.pdf");
			ret.setForwardId("xlsDo");
		return ret;
		} catch(Exception e){
			e.printStackTrace();
